    ...
    },
    {
      ...
      admin: {
        condition: (data, siblingData) =>
          ["two-columns", "three-columns", "sidebar-left", "sidebar-right"].includes(siblingData?.layoutType),
      },
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: "Overlay Color",
          admin: {
            condition: (data, siblingData) => siblingData?.enable === true && siblingData?.overlay === true,
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          admin: {
            condition: (data, siblingData) => siblingData?.enable === true && siblingData?.type === "linear",
          },
        },
        {
          name: "colorStops",
