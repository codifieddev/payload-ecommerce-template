...
export function VisualEditingClient({ pageId, collection = "pages" }: VisualEditingClientProps) {
  useEffect(() => {
    ...
    const openInlineEditor = (
      element: HTMLElement,
      blockData: { collection: string; docId: string; field: string; currentText: string },
    ) => {
      ...
      const textarea = modal.querySelector<HTMLTextAreaElement>("#content-editor")!;
    ...
    const initializeVisualEditing = async () => {
      ...
      const setupEditableBlocks = () => {
        const blocks = document.querySelectorAll('[data-visual-editing="true"]');
        ...
        blocks.forEach((block) => {
          ...
          const editableElements = element.querySelectorAll("[data-editable-field]");

          editableElements.forEach((editableEl) => {
            const editableElement = editableEl as HTMLElement;
            const fieldPath = editableElement.getAttribute("data-editable-field");
            ...
            editableElement.addEventListener("click", (e) => {
              ...
              console.log("📝 Editing field:", { collection, docId, field: fieldPath, text });
          ...
          textElements.forEach((textEl) => {
            ...
            textElement.addEventListener("click", (e) => {
              ...
              console.log("📝 Editing (auto-detected):", { collection, docId, field: blockFieldPath, text });
